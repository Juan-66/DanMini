...
echo -e "\033[1;35m"
git clone https://github.com/Juan-66/DanMini.git
...
echo -e "\033[01;32m\033[01mIniciando DanMini!!\nStarting CatBot!!\n\033[0m"
npm start
